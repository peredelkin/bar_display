...
////////////////////////////////////////////
	...
	SSD2828_send_acmd(SSD2828_ENTER_FITI_CMD_COUNT);
	// передать ssd2828_enter_fiti_cmd

	SSD2828_send_acmd(SSD2828_REG_0x41_COUNT);
	// передать ssd2828_reg_0x41_0x34

	SSD2828_send_acmd(SSD2828_REG_0x30_COUNT);
	// передать ssd2828_reg_0x30

	SSD2828_send_acmd(SSD2828_REG_0x39_COUNT);
	// передать ssd2828_reg_0x39

	SSD2828_send_acmd(SSD2828_REG_0x32_COUNT);
	// передать ssd2828_reg_0x32

	SSD2828_send_acmd(SSD2828_REG_0x33_COUNT);
	// передать ssd2828_reg_0x33

	SSD2828_send_acmd(SSD2828_REG_0x35_COUNT);
	// передать ssd2828_reg_0x35

	SSD2828_send_acmd(SSD2828_REG_0x4F_COUNT);
	// передать ssd2828_reg_0x4F

	SSD2828_send_acmd(SSD2828_REG_0x4E_COUNT);
	// передать ssd2828_reg_0x4E

	SSD2828_send_acmd(SSD2828_REG_0x41_COUNT);
	// передать ssd2828_reg_0x41_0x56

	SSD2828_send_acmd(SSD2828_GSTV_COUNT);
	// передать ssd2828_gstv

	SSD2828_send_acmd(SSD2828_GCKV_COUNT);
	// передать ssd2828_gckv

	SSD2828_send_acmd(SSD2828_REG_0x65_COUNT);
	// передать ssd2828_reg_0x65

	SSD2828_send_acmd(SSD2828_REG_0x3A_COUNT);
	// передать ssd2828_reg_0x3A

	SSD2828_send_acmd(SSD2828_REG_0x36_COUNT);
	// передать ssd2828_reg_0x36

	SSD2828_send_acmd(SSD2828_REG_0x67_COUNT);
	// передать ssd2828_reg_0x67

	SSD2828_send_acmd(SSD2828_REG_0x69_COUNT);
	// передать ssd2828_reg_0x69

	SSD2828_send_acmd(SSD2828_REG_0x6C_COUNT);
	// передать ssd2828_reg_0x6C

	SSD2828_send_acmd(SSD2828_REG_0x6D_COUNT);
	// передать ssd2828_reg_0x6D

	SSD2828_send_acmd(SSD2828_POS_GAMMA_COUNT);
	// передать ssd2828_pos_gamma

	SSD2828_send_acmd(SSD2828_NEG_GAMMA_COUNT);
	// передать ssd2828_neg_gamma

	SSD2828_send_acmd(SSD2828_REG_0x6B_COUNT);
	// передать ssd2828_reg_0x6B

	SSD2828_send_acmd(SSD2828_REG_0x58_COUNT);
	// передать ssd2828_reg_0x58

	SSD2828_send_acmd(SSD2828_REG_0x73_COUNT);
	// передать ssd2828_reg_0x73

	SSD2828_send_acmd(SSD2828_REG_0x76_COUNT);
	// передать ssd2828_reg_0x76

	SSD2828_send_acmd(SSD2828_REG_0x77_COUNT);
	// передать ssd2828_reg_0x77

	SSD2828_send_acmd(SSD2828_REG_0x74_COUNT);
	// передать ssd2828_reg_0x74

	SSD2828_send_acmd(SSD2828_REG_0x5E_COUNT);
	// передать ssd2828_reg_0x5E

	SSD2828_send_acmd(SSD2828_REG_0x68_COUNT);
	// передать ssd2828_reg_0x68

	SSD2828_send_acmd(SSD2828_REG_0x6A_COUNT);
	// передать ssd2828_reg_0x6A

	SSD2828_send_acmd(SSD2828_REG_0x28_COUNT);
	// передать ssd2828_reg_0x28

	SSD2828_send_acmd(SSD2828_REG_0x29_COUNT);
	// передать ssd2828_reg_0x29

	SSD2828_send_acmd(SSD2828_REG_0x63_COUNT);
	// передать ssd2828_reg_0x63

	SSD2828_send_acmd(SSD2828_REG_0x27_COUNT);
	// передать ssd2828_reg_0x27

	SSD2828_send_acmd(SSD2828_REG_0x7C_COUNT);
	// передать ssd2828_reg_0x7C

	SSD2828_send_acmd(SSD2828_REG_0x2E_COUNT);
	// передать ssd2828_reg_0x2E

	SSD2828_send_acmd(SSD2828_REG_0x4C_COUNT);
	// передать ssd2828_reg_0x4C

	SSD2828_send_acmd(SSD2828_REG_0x50_COUNT);
	// передать ssd2828_reg_0x50

	SSD2828_send_acmd(SSD2828_REG_0x78_COUNT);
	// передать ssd2828_reg_0x78

	SSD2828_send_acmd(SSD2828_REG_0x2D_COUNT);
	// передать ssd2828_reg_0x2D

	SSD2828_send_acmd(SSD2828_REG_0x49_COUNT);
	// передать ssd2828_reg_0x49

	SSD2828_send_acmd(SSD2828_EXIT_FITI_CMD_COUNT);
	// передать ssd2828_exit_fiti_cmd
